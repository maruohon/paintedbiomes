    ...
    private static void overrideWorldChunkManager(World world)
    {
        ...
        for (int i : Configs.getEffectiveMainConfig().enabledInDimensions)
        {
            if (dimension == i)
            {
                ...
                overrideWorldChunkManager(dimension, world, imageHandler);
                break;
            }
        }
    }

    private static void overrideWorldChunkManager(int dimension, World world, ImageHandler imageHandler)
    {
